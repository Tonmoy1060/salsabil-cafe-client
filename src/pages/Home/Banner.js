...
const Banner = () => {
  ...
  return (
    <div
      ...
      className="p-5 "
    >
      <div className="flex  items-center font-semibold tracking-wide lg:px-20 px-5 mx-3 my-[-10px] text-white">
      ...
      <div className="lg:px-20">
        <div className="card  p-8 lg:py-20">
          <div className="card-body  text-neutral-content ">
            <h2 className="card-title font-bold text-6xl font-serif ">
              Welcome Back <br />
              to tasty
            </h2>
            <p className="py-7">
